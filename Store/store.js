...
function addToCartClicked(event) {
  ...
  // Erstelle das benutzerdefinierte Modalfenster
  var modal = document.createElement("div");
  modal.classList.add("alert-modal");

  // Füge den Inhalt hinzu
  var modalContent = `
    <h2>The item has been successfully added to cart!</h2>
    <button onclick="this.parentElement.remove()">OK</button>
  `;
  modal.innerHTML = modalContent;

  // Füge das Modalfenster zum Dokument hinzu
  document.body.appendChild(modal);
}

function purchaseClicked() {
  alert("You have to choose your payment method");
...
// Ersetze die Standard alert-Funktion
